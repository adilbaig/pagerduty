...
switch ($response['code']) {
    case 200:
        echo "Success. Incident Key = ", $response['incident_key'];
        break;
    case 403: //You're being throttled. Slow down.
        echo "Rate Limited";
        break;
    default: //This doesn't happen unless you've broken their guidelines. The API tries to minimize user mistakes
        echo "ERROR!";
        var_dump($response);
}
